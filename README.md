...
![Sidebar](Images/Page_sidebar.png)
...
#### Page 4: Discounts 
On tgis page, we get to see the impact of discounts on sales as well as profits and identify areas where a good balance needs to be striked such that profitability is not negatively affected.
